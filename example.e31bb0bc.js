...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/vue-class-component/dist/vue-class-component.common.js":[function(require,module,exports) {
/**
...
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js","vue-class-component":"../node_modules/vue-class-component/dist/vue-class-component.common.js"}],"../src/index.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function (_super) {
  __extends(VueFixedHeader, _super);

  function VueFixedHeader() {
  ...
  VueFixedHeader.prototype.mounted = function () {
    this.$ = function (e) {
  ...
  VueFixedHeader.prototype.main = function () {
    var _this = this;
    ...
    this.check = function () {
      ...
      _this.$emit('update:fixed', $(tag).scrollTop > threshold);
    };

    window.addEventListener('scroll', this.check);
  };

  VueFixedHeader.prototype.beforeDestroy = function () {
    window.removeEventListener('scroll', this.check);
  };

  VueFixedHeader.prototype.render = function () {
    var children = this.$slots.default;
    return children[0];
  };
  ...
  __decorate([(0, _vuePropertyDecorator.Prop)({
    default: 0,
    type: Number
  }), __metadata("design:type", Number)], VueFixedHeader.prototype, "threshold", void 0);

  VueFixedHeader = __decorate([_vuePropertyDecorator.Component], VueFixedHeader);
  return VueFixedHeader;
}(_vue.default);

var _default = VueFixedHeader;
exports.default = _default;
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js","vue-property-decorator":"../node_modules/vue-property-decorator/lib/vue-property-decorator.js"}],"../node_modules/vue-hot-reload-api/dist/index.js":[function(require,module,exports) {
var Vue // late bind
var version
var map = Object.create(null)
...
var _default = _vue.default.extend({
  ...
  computed: {
    sampleCode: function sampleCode() {
      return "<fixed-header :fixed.sync=\"isFixed\">\n  <div :class=\"{ 'is-fixed': isFixed }\">\n    Your Content\n  </div>\n</fixed-header>";
    }
  }
});

exports.default = _default;
        var $216460 = exports.default || module.exports;
      
      if (typeof $216460 === 'function') {
        $216460 = $216460.options;
      }
    
        /* template */
        Object.assign($216460, (function () {
          var render = function() {
  var _vm = this
      ...
      _c(
        ...
        [
          _c(
            ...
            {
              staticClass: "navbar",
              class: { "is-light": _vm.isFixed, "is-primary": !_vm.isFixed }
            },
            [
      ...
      _c("section", { staticClass: "section" }, [
        _c("div", { staticClass: "container" }, [
          _c("div", { staticClass: "content" }, [
            _c("h2", [_vm._v("\n          Usage\n        ")]),
            _vm._v(" "),
            _c("pre", [_c("code", [_vm._v(_vm._s(_vm.sampleCode))])])
          ])
        ])
      ]),
      _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "section",
      { staticClass: "hero is-medium has-text-centered is-primary" },
      [
    ...
    return _c("section", { staticClass: "section" }, [
      _c("div", { staticClass: "container" }, [
        _c("div", { staticClass: "content" }, [
          ...
          _c("p", [
            _vm._v(
              "\n          This is simple and cross-browser friendly fixed header component for Vue.js written by TypeScript."
            ),
            _c("br"),
            _vm._v(
              "\n          It provides a concise interface that can be manipulated by "
            ),
            _c("code", [_vm._v(":fixed.sync")]),
            _vm._v(" directive.\n        ")
          ])
        ])
      ])
    ...
    return _c("section", { staticClass: "section" }, [
      _c("div", { staticClass: "container" }, [
        _c("div", { staticClass: "content" }, [
          _c("h2", [_vm._v("\n          Props\n        ")]),
          _vm._v(" "),
          _c("table", { staticClass: "is-border" }, [
            _c("thead", [
              _c("tr", [
                _c("th", [_vm._v("\n                name\n              ")]),
                _vm._v(" "),
          ...
          _c("p", [
            _c(
              "a",
              {
                attrs: {
                  href:
                    "https://github.com/potato4d/vue-fixed-header/blob/master/LICENSE"
                }
              },
              [_vm._v("MIT")]
            )
        ...
        _c("div", { staticClass: "content" }, [
          ...
          _c("p", [
            ...
            _c(
              "a",
              {
                attrs: { href: "https://github.com/potato4d/vue-fixed-header" }
              },
              [_vm._v("GitHub")]
            )
          ])
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$216460', $216460);
          } else {
            api.reload('$216460', $216460);
          }
        }
...
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js","bulma/css/bulma.css":"../node_modules/bulma/css/bulma.css","../src/":"../src/index.ts","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js"}],"index.js":[function(require,module,exports) {
"use strict";
